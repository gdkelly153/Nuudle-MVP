...
const prompts = {
  ...
  identify_assumptions_discovery: {
    ...
    body: {
      analysis: "Based on the problem and causes provided, identify 3-4 potential assumptions the user might be making that would be worth examining. For each, state the potential assumption plainly, then ask a question to help validate it. Do not use labels like 'Assumption:' or 'Question:'. Instead, present the assumption and question together in a natural, conversational way within a single bullet point. For example: 'It appears you believe that you need to have a complete plan before starting. What's the smallest step you could take to begin learning?' Present these in bullet points. Use the following context for your analysis but do not repeat it: The user's problem is '{{painPoint}}' and the causes are '{{causes}}'.",
